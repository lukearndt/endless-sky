...
const Command Command::BOARDING_ATTACK_STRATEGY(ONE << 38, "Toggle attack strategy");
const Command Command::BOARDING_DEFENSE_STRATEGY(ONE << 39, "Toggle defense strategy");
