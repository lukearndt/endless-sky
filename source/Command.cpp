...
const Command Command::BOARDING_ATTACK_STRATEGY(ONE << 38, "Toggle boarding attack strategy");
const Command Command::BOARDING_DEFENSE_STRATEGY(ONE << 39, "Toggle boarding defense strategy");
const Command Command::WAIT(ONE << 40, "");
const Command Command::STOP(ONE << 41, "");
